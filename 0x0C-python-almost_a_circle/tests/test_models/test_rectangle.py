...
class TestRectangle_x(unittest.TestCase):
    ...
    def test_complex_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(4, 2, complex(5), 4)

    def test_dict_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(4, 2, {'a': 3, 'b': 8}, 4)

    def test_list_x(self):
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            Rectangle(4, 2, [1, 2, 2, 5], 4)
...
class TestRectangle_y(unittest.TestCase):
    ...
    def test_complex_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(4, 2, 4, complex(5))

    def test_dict_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(4, 2, 4, {'a': 3, 'b': 8})

    def test_list_y(self):
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            Rectangle(4, 2, 4, [1, 2, 2, 5])
...
class TestRectangle_area(unittest.TestCase):
    ...
    def test_area_equal(self):
        result = Rectangle(10, 6, 0, 0)
        self.assertEqual(60, result.area())
