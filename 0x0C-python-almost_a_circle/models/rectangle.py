...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """Return the current x of the rectangle"""
        return self.__x
    ...
    @property
    def y(self):
        """Return the current y of the rectangle"""
        return self.__y
    ...
    def display(self):
        """Return the the stdout of instance with the character"""
    ...
    def __str__(self):
        ...
        return "[Rectangle] ({:d}) {}/{} - {}/{}".format(self.id, self.x,
                                                         self.y, self.width,
                                                         self.height)
